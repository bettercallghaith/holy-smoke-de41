...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/holy-smoke-de41)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/holy-smoke-de41
```

A live public deployment of this template is available at [https://holy-smoke-de41.templates.workers.dev](https://holy-smoke-de41.templates.workers.dev)
